...
public class Login extends JFrame implements ActionListener{
    ...
    Login(){
        ...
        l3 = new JLabel(icc3);
        //inorder to add  image on frame we have to add it in label then it will piont to frame 
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        try{        
            ...
            ResultSet rs = c1.s.executeQuery(q);// executeQuery(q)--retrive data from database
            if(rs.next()){
